...
import { pipeline } from 'https://cdn.jsdelivr.net/npm/@xenova/transformers-js@2.7.0/dist/transformers.min.js';
...
serve(async (req) => {
  ...
  try {
    ...
    // Create a feature-extraction pipeline with a smaller model
